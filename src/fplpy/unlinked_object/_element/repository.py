...
class BaseRepository(ABC, Generic[T_element, T_source]):
...
class BaseRepositoryWithID(BaseRepository[T_element_with_id, T_source], ABC, Generic[T_element_with_id, T_source]):
